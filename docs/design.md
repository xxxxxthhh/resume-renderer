...
The immediate use case is an OpenAI application package. The public version must stand alone with generic examples and must not expose private application materials.
...
- Keep source Markdown portable and readable.
...
- README documents setup, rendering, analysis, privacy boundaries, and public example usage.
...
7. `feat: analyze application materials with openai`
8. `feat: render cover letter`
9. `docs: add public examples and usage`
...
This project should not block the current OpenAI application submission. The application package is already ready to submit; this tool belongs to the post-submission proof-building track and can later become a public GitHub pin.
